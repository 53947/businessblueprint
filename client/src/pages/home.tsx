...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-blue-50 via-white to-gray-50 py-12 lg:py-20 border-b-2 border-gray-300">
      ...
      {/* Section 1: / connect */}
      <section className="bg-white py-20 border-b-2 border-gray-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="bg-gray-50 py-20 border-b-2 border-gray-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="bg-[#09080E] py-20 border-b-2 border-gray-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
