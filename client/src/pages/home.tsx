...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-blue-50 via-white to-gray-50 py-12 lg:py-20 border-b border-gray-100">
              ...
              <div className="p-4 rounded-xl shadow-lg relative overflow-hidden" style={{ backgroundColor: "#064A6C" }}>
                ...
                <div className="space-y-3 relative z-10">
                  {[
                    ...
                    { title: "Own Your Local Presence — / anchor suite", desc: "Claim your Google Business listing. Register your D&B DUNS number. Get listed everywhere your customers are looking — all from one place.", color: "#2073E3" },
          ...
          <div className="lg:grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="mt-12 lg:mt-0">
              <div className="relative h-96 flex items-center justify-center">
                <div className="rounded-full w-24 h-24 flex items-center justify-center text-white text-sm font-bold text-center" style={{ backgroundColor: '#008060' }}>/ connect</div>
                <div className="absolute text-xs font-medium px-3 py-2.5 rounded-full shadow-sm" style={{ border: '2px solid #064A6C', backgroundColor: '#064A6C', color: '#E9ECF0', letterSpacing: '0.05em', top: '0', left: '50%', transform: 'translateX(-50%)' }}>/ publish</div>
                <div className="absolute text-xs font-medium px-3 py-2.5 rounded-full shadow-sm" style={{ border: '2px solid #E9B307', backgroundColor: '#E9B307', color: '#09080E', letterSpacing: '0.05em', top: '15%', right: '5%' }}>/ elevate</div>
                <div className="absolute text-xs font-medium px-3 py-2.5 rounded-full shadow-sm" style={{ border: '2px solid #374151', backgroundColor: '#374151', color: '#E9ECF0', letterSpacing: '0.05em', top: '50%', right: '0', transform: 'translateY(-50%)' }}>/ optimize</div>
                <div className="absolute text-xs font-medium px-3 py-2.5 rounded-full shadow-sm" style={{ border: '2px solid #97ACCA', backgroundColor: '#97ACCA', color: '#09080E', letterSpacing: '0.05em', bottom: '15%', right: '5%' }}>/ amplify</div>
                <div className="absolute text-xs font-medium px-3 py-2.5 rounded-full shadow-sm" style={{ border: '2px solid #001882', backgroundColor: '#001882', color: '#E9ECF0', letterSpacing: '0.05em', bottom: '0', left: '50%', transform: 'translateX(-50%)' }}>/ respond</div>
                <div className="absolute text-xs font-medium px-3 py-2.5 rounded-full shadow-sm" style={{ border: '2px solid #660099', backgroundColor: '#660099', color: '#E9ECF0', letterSpacing: '0.05em', bottom: '15%', left: '5%' }}>/ engage</div>
                <div className="absolute text-xs font-medium px-3 py-2.5 rounded-full shadow-sm" style={{ border: '2px solid #FF44CC', backgroundColor: '#FF44CC', color: '#09080E', letterSpacing: '0.05em', top: '50%', left: '0', transform: 'translateY(-50%)' }}>/ post</div>
                <div className="absolute text-xs font-medium px-3 py-2.5 rounded-full shadow-sm" style={{ border: '2px solid #1844A6', backgroundColor: '#1844A6', color: '#E9ECF0', letterSpacing: '0.05em', top: '15%', left: '5%' }}>/ promote</div>
              </div>
      ...
      <section className="bg-[#09080E] py-20 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
