      ...
      <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-purple-700 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Choose the perfect pathway for your business: DIY control, expert
            MSP guidance, or flexible à la carte services.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            {/* DIY Pathway */}
            <Card
              className="border-2 border-orange-400 hover:border-orange-500 transition-all hover:shadow-xl"
            ...
            >
              <CardContent className="p-8">
                ...
                <p className="text-white/90 mb-6 text-lg leading-relaxed">
                  Perfect for hands-on business owners who want full control.
                  Access powerful tools, automation, and AI assistance—all at
                  your fingertips.
                </p>
            ...
            {/* ALC Pathway */}
            <Card
              className="border-2 border-green-400 hover:border-green-500 transition-all hover:shadow-xl"
            ...
            >
              <CardContent className="p-8">
                ...
                <p className="text-black/80 mb-6 text-base leading-relaxed">
                  Build your own solution. Choose exactly which apps and
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Three powerful platforms working together to power your digital
              success
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="border border-gray-200 hover:shadow-xl transition-all">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  AI-powered digital intelligence platform with assessment,
            ...
            <Card className="border border-gray-200 hover:shadow-xl transition-all">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Managed WordPress hosting, domains, and premium website
                  services
                </p>
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="flex items-center gap-2">
            ...
            <Card className="border border-gray-200 hover:shadow-xl transition-all">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Secure payment gateway for accepting online payments across
                  all platforms
                </p>
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="flex items-center gap-2">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <Card className="border-2 border-blue-200 hover:shadow-xl transition-all">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-4">
                  Your 24/7 AI business advisor. Get personalized strategies,
                  automated insights, and smart recommendations based on your
                  business data.
                </p>
                ...
                <div className="bg-blue-50 rounded-lg p-3 text-sm">
                  ...
                  Included in Advanced & Scale plans, add-on for Start
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 border-orange-200 hover:shadow-xl transition-all">
              <CardContent className="p-8">
                ...
                <p className="text-gray-700 mb-4">
                  One-on-one coaching with a dedicated business strategist.
                  Weekly sessions, custom action plans, and accountability
                  support.
                </p>
                <ul className="space-y-2 text-sm text-gray-700 mb-6">
                  <li className="flex items-center gap-2">
                ...
                <div className="bg-orange-50 rounded-lg p-3 text-sm">
                  ...
                  $249/month for personalized coaching
                </div>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Explore our complete marketplace to build your perfect digital
            strategy
          </p>
