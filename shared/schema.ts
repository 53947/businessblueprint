...
export const scansBluePurchases = pgTable("scans_blue_purchases", {
  ...
  paymentProvider: varchar("payment_provider", { length: 20 })
    .notNull()
    .default("swipesblue"), // 'stripe' or 'swipesblue'
...
export const insertScansBluePurchaseSchema = createInsertSchema(
  scansBluePurchases,
...
export const insertAccountStatusHistorySchema = createInsertSchema(
...
export const insertEmailChangeHistorySchema = createInsertSchema(
  emailChangeHistory,
).pick({
  clientId: true,
  oldEmail: true,
...
export const subscriptions = pgTable("subscriptions", {
  id: serial("id").primaryKey(),
  swipesblueSubscriptionId: varchar("swipesblue_subscription_id", {
    length: 100,
  }).unique(),
  assessmentId: integer("assessment_id").references(() => assessments.id),
  clientId: integer("client_id").references(() => clients.id),
  ...
  addonAmount: decimal("addon_amount", { precision: 10, scale: 2 }).default(
    "0.00",
  ),
...
export const subscriptionAddonSelections = pgTable(
...
export const assessmentProductRecommendations = pgTable(
  "assessment_product_recommendations",
  {
    id: serial("id").primaryKey(),
    assessmentId: integer("assessment_id").references(() => assessments.id),
...
export const billingHistory = pgTable("billing_history", {
  ...
  swipesblueTransactionId: varchar("swipesblue_transaction_id", {
    length: 100,
  }),
...
export const insertSubscriptionAddonSchema = createInsertSchema(
  subscriptionAddons,
).pick({
  addonId: true,
  name: true,
...
export const insertAssessmentProductRecommendationSchema = createInsertSchema(
...
export type InsertEmailChangeHistory = z.infer<
  typeof insertEmailChangeHistorySchema
>;
...
export type InsertAccountStatusHistory = z.infer<
  typeof insertAccountStatusHistorySchema
>;
...
export type InsertSubscriptionAddon = z.infer<
  typeof insertSubscriptionAddonSchema
>;
export type Subscription = typeof subscriptions.$inferSelect;
export type InsertSubscription = z.infer<typeof insertSubscriptionSchema>;
export type SubscriptionAddonSelection =
  typeof subscriptionAddonSelections.$inferSelect;
...
export type AssessmentProductRecommendation =
  typeof assessmentProductRecommendations.$inferSelect;
export type InsertAssessmentProductRecommendation = z.infer<
  typeof insertAssessmentProductRecommendationSchema
>;
...
export const sendContacts = pgTable(
  "send_contacts",
  {
    id: serial("id").primaryKey(),
    clientId: integer("client_id").references(() => clients.id),
...
export const sendListContacts = pgTable(
  "send_list_contacts",
  {
    id: serial("id").primaryKey(),
...
export const sendSuppressionList = pgTable(
  "send_suppression_list",
  {
    id: serial("id").primaryKey(),
    clientId: integer("client_id").references(() => clients.id),
...
export const insertSendAutomationSchema = createInsertSchema(
  sendAutomations,
).pick({
  clientId: true,
  name: true,
...
export const domains = pgTable(
  ...
  (table) => [unique().on(table.clientId, table.domain)],
);
...
export const impersonationSessions = pgTable("impersonation_sessions", {
  ...
  targetUserId: integer("target_user_id")
    .references(() => clients.id)
    .notNull(), // user being impersonated
  ...
  restrictedActions: text("restricted_actions")
    .array()
    .default(sql`ARRAY['delete_account', 'change_password', 'modify_billing']`),
...
export const insertDomainTransferSchema = createInsertSchema(
  domainTransfers,
).pick({
  domainId: true,
  clientId: true,
...
export const insertImpersonationAuditSchema = createInsertSchema(
...
export type InsertImpersonationAudit = z.infer<
  typeof insertImpersonationAuditSchema
>;
...
export const inboxChannelConnections = pgTable(
...
export const inboxConversations = pgTable(
  "inbox_conversations",
  {
    ...
    primaryChannelType: varchar("primary_channel_type", {
      length: 50,
    }).notNull(),
    primaryChannelId: integer("primary_channel_id").references(
      () => inboxChannelConnections.id,
    ),
...
export const inboxMessages2 = pgTable(
  "inbox_messages2",
  {
    id: serial("id").primaryKey(),
...
export const inboxAttachments = pgTable("inbox_attachments", {
  ...
  messageId: integer("message_id")
    .references(() => inboxMessages2.id, { onDelete: "cascade" })
    .notNull(),
...
export const inboxQuickReplies = pgTable(
  "inbox_quick_replies",
  {
    id: serial("id").primaryKey(),
    clientId: integer("client_id")
  ...
  (table) => [unique().on(table.clientId, table.shortcut)],
);
...
export const inboxParticipants = pgTable(
  "inbox_participants",
  {
    ...
    participantIdentifier: varchar("participant_identifier", {
      length: 255,
    }).notNull(),
  ...
  (table) => [unique().on(table.conversationId, table.participantIdentifier)],
);
...
export const insertChannelConnectionSchema = createInsertSchema(
  inboxChannelConnections,
).pick({
  clientId: true,
  channelType: true,
...
export const insertInboxMessage2Schema = createInsertSchema(
  inboxMessages2,
).pick({
  conversationId: true,
  channelType: true,
...
export const insertQuickReplySchema = createInsertSchema(
  inboxQuickReplies,
).pick({
  clientId: true,
  shortcut: true,
...
export const insertLivechatSessionSchema = createInsertSchema(
  livechatSessions,
).pick({
  clientId: true,
  conversationId: true,
...
export type InsertChannelConnection = z.infer<
  typeof insertChannelConnectionSchema
>;
...
export const socialMediaAccounts = pgTable(
  "social_media_accounts",
  {
    ...
    platformAccountId: varchar("platform_account_id", {
      length: 255,
    }).notNull(), // Platform's user/page ID
    platformAccountName: varchar("platform_account_name", {
      length: 255,
    }).notNull(), // Display name
...
export const contentAnalytics = pgTable(
  ...
  (table) => [unique().on(table.postId, table.platform)],
);
...
export const aiCoachMessages = pgTable("ai_coach_messages", {
  id: serial("id").primaryKey(),
  conversationId: integer("conversation_id")
    .references(() => aiCoachConversations.id)
    .notNull(),
...
export const crmTimeline = pgTable(
  "crm_timeline",
  {
    id: serial("id").primaryKey(),
    clientId: integer("client_id").references(() => clients.id),
...
export const crmSegmentMembers = pgTable(
  "crm_segment_members",
  {
    id: serial("id").primaryKey(),
    segmentId: integer("segment_id")
      .references(() => crmSegments.id)
      .notNull(),
    contactId: integer("contact_id")
  ...
  (table) => [unique().on(table.segmentId, table.contactId)],
);
...
export const crmLeadForms = pgTable(
  "crm_lead_forms",
  {
    id: serial("id").primaryKey(),
    clientId: integer("client_id").references(() => clients.id),
    ...
    successMessage: varchar("success_message", { length: 255 }).default(
      "Thank you! We'll be in touch soon.",
    ),

    // Lead assignment
    defaultLifecycleStage: varchar("default_lifecycle_stage", {
      length: 50,
    }).default("lead"),
...
export const insertCrmPipelineStageSchema = createInsertSchema(
  crmPipelineStages,
).omit({
  id: true,
  createdAt: true,
...
export const insertCrmAppointmentSchema = createInsertSchema(
  crmAppointments,
).omit({
  id: true,
  createdAt: true,
...
export const insertCrmCustomFieldDefSchema = createInsertSchema(
  crmCustomFieldDefs,
).omit({
  id: true,
  createdAt: true,
...
export const insertCrmSubscriptionSchema = createInsertSchema(
  crmSubscriptions,
).omit({
  id: true,
  createdAt: true,
...
export const insertCrmAutomationSchema = createInsertSchema(
  crmAutomations,
).omit({
  id: true,
  createdAt: true,
...
export const insertCrmAutomationStepSchema = createInsertSchema(
  crmAutomationSteps,
).omit({
  id: true,
  createdAt: true,
...
export type InsertCrmPipelineStage = z.infer<
  typeof insertCrmPipelineStageSchema
>;
...
export type InsertCrmCustomFieldDef = z.infer<
  typeof insertCrmCustomFieldDefSchema
>;
...
export type InsertCrmAutomationStep = z.infer<
  typeof insertCrmAutomationStepSchema
>;
...
export const setupTasks = pgTable(
  "setup_tasks",
  {
    id: serial("id").primaryKey(),
    clientId: integer("client_id")
...
export const setupNotes = pgTable(
  "setup_notes",
  {
    id: serial("id").primaryKey(),
    clientId: integer("client_id")
  ...
  (table) => [
    ...
    index("idx_setup_notes_location").on(
      table.clientId,
      table.appId,
      table.stepId,
    ),
...
export const setupTaskEvents = pgTable(
  "setup_task_events",
  {
    id: serial("id").primaryKey(),
    clientId: integer("client_id")
...
export const insertListingSyncLogSchema = createInsertSchema(
  listingSyncLogs,
).omit({
  id: true,
  startedAt: true,
...
export type ListingMetricsSnapshot =
  typeof listingMetricsSnapshots.$inferSelect;
...
export const canonicalBusinessProfiles = pgTable(
  ...
  (table) => [index("idx_canonical_profiles_client").on(table.clientId)],
);
...
export const distributionSubmissions = pgTable(
  "distribution_submissions",
  {
    ...
    profileId: integer("profile_id")
      .references(() => canonicalBusinessProfiles.id)
      .notNull(),
  ...
  (table) => [
    ...
    unique("uq_dist_submissions_client_target").on(
      table.clientId,
      table.targetId,
    ),
  ],
...
export const insertCanonicalProfileSchema = createInsertSchema(
...
// Distribution Types
export type CanonicalBusinessProfile =
  typeof canonicalBusinessProfiles.$inferSelect;
export type InsertCanonicalProfile = z.infer<
  typeof insertCanonicalProfileSchema
>;
export type UpdateCanonicalProfile = z.infer<
  typeof updateCanonicalProfileSchema
>;
export type DistributionTarget = typeof distributionTargets.$inferSelect;
export type DistributionSubmission =
  typeof distributionSubmissions.$inferSelect;
 ...
 */
export const chatAnalyticsEvents = pgTable(
...
// Chat Widget Schemas
export const insertChatWidgetSettingsSchema =
  createInsertSchema(chatWidgetSettings);
export const updateChatWidgetSettingsSchema = insertChatWidgetSettingsSchema
  .partial()
  .omit({ id: true, clientId: true, createdAt: true });
export const insertChatAgentSchema = createInsertSchema(chatAgents);
export const insertChatAnalyticsEventSchema =
  createInsertSchema(chatAnalyticsEvents);

// Chat Widget Types
export type ChatWidgetSettings = typeof chatWidgetSettings.$inferSelect;
export type InsertChatWidgetSettings = z.infer<
  typeof insertChatWidgetSettingsSchema
>;
export type UpdateChatWidgetSettings = z.infer<
  typeof updateChatWidgetSettingsSchema
>;
...
export type InsertChatAnalyticsEvent = z.infer<
  typeof insertChatAnalyticsEventSchema
>;
...
export const seoProfiles = pgTable(
  ...
  (table) => [index("idx_seo_profile_client").on(table.clientId)],
);
...
export const seoKeywords = pgTable(
  ...
  (table) => [index("idx_seo_keyword_profile").on(table.profileId)],
);
...
export const seoPages = pgTable(
  ...
  (table) => [index("idx_seo_page_profile").on(table.profileId)],
);

/**
 * SEO Technical Issues — Technical issues found during audits.
 */
export const seoTechnicalIssues = pgTable(
...
export const seoBacklinks = pgTable(
  ...
  (table) => [index("idx_seo_backlink_profile").on(table.profileId)],
);

/**
 * SEO Content Briefs — AI-generated content briefs.
 */
export const seoContentBriefs = pgTable(
  "seo_content_briefs",
  {
    id: serial("id").primaryKey(),
    profileId: integer("profile_id")
  ...
  (table) => [index("idx_seo_brief_profile").on(table.profileId)],
);

/**
 * SEO Action Items — AI-generated prioritized action items.
 */
export const seoActionItems = pgTable(
  "seo_action_items",
  {
    id: serial("id").primaryKey(),
    profileId: integer("profile_id")
...
export const seoReports = pgTable(
  ...
  (table) => [index("idx_seo_report_profile").on(table.profileId)],
);
...
export const seoCompetitors = pgTable(
  ...
  (table) => [index("idx_seo_competitor_profile").on(table.profileId)],
);

/**
 * SEO Competitor Data — Competitor metrics (shell/placeholder).
 */
export const seoCompetitorData = pgTable(
  "seo_competitor_data",
  {
    id: serial("id").primaryKey(),
    competitorId: integer("competitor_id")
      .references(() => seoCompetitors.id)
      .notNull(),
    metric: varchar("metric", { length: 100 }),
    value: text("value"),
    date: timestamp("date").defaultNow(),
  },
  (table) => [index("idx_seo_comp_data_competitor").on(table.competitorId)],
);
...
export const insertSeoKeywordRankingSchema =
  createInsertSchema(seoKeywordRankings);
export const insertSeoPageSchema = createInsertSchema(seoPages);
export const insertSeoTechnicalIssueSchema =
  createInsertSchema(seoTechnicalIssues);
...
export const insertSeoCompetitorDataSchema =
  createInsertSchema(seoCompetitorData);
...
export type InsertSeoKeywordRanking = z.infer<
  typeof insertSeoKeywordRankingSchema
>;
export type SeoPage = typeof seoPages.$inferSelect;
export type InsertSeoPage = z.infer<typeof insertSeoPageSchema>;
export type SeoTechnicalIssue = typeof seoTechnicalIssues.$inferSelect;
export type InsertSeoTechnicalIssue = z.infer<
  typeof insertSeoTechnicalIssueSchema
>;
...
export type InsertSeoCompetitorData = z.infer<
  typeof insertSeoCompetitorDataSchema
>;
...
export const insertAdAccountConnectionSchema =
  createInsertSchema(adAccountConnections);
...
export const insertAmplifyBudgetAllocationSchema = createInsertSchema(
  amplifyBudgetAllocations,
);
export const insertAmplifySpendAlertSchema =
  createInsertSchema(amplifySpendAlerts);
...
export type InsertAdAccountConnection = z.infer<
  typeof insertAdAccountConnectionSchema
>;
...
export type AmplifyBudgetAllocation =
  typeof amplifyBudgetAllocations.$inferSelect;
export type InsertAmplifyBudgetAllocation = z.infer<
  typeof insertAmplifyBudgetAllocationSchema
>;
export type AmplifySpendAlert = typeof amplifySpendAlerts.$inferSelect;
export type InsertAmplifySpendAlert = z.infer<
  typeof insertAmplifySpendAlertSchema
>;
