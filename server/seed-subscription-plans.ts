...
const plans = [
  // DIY TIERS
  {
    ...
    features: [
      "Business List Management (100 locations)",
      "Review Management",
      "Post Management",
      "Local SEO & Rank Tracking",
      "/send - Email + SMS Marketing Platform",
      "/respond - Unified Communications Hub",
  ...
  },
  {
    ...
    pathway: "diy",
    tierLevel: "growth",
    basePrice: "316.00", // $250 + $35 (List Pro) + $20 (Review Pro) + $6 (Post Pro) + $5 (SEO Pro)
    setupFee: "0.00",
    billingCycle: "monthly",
    features: [
      "Business List Management (100 locations)",
      ...
      "/respond - Unified Communications Hub",
      "/livechat - Live Chat Widget",
      "List Pro - Advanced listing features",
      "Review Pro - Enhanced review management",
      "Post Pro - Advanced social media tools",
  ...
  // MSP TIERS
  {
    ...
    features: [
      ...
      "/respond - Unified Communications Hub (Managed)",
  ...
  },
  {
    ...
    billingCycle: "monthly",
    features: [
      "Business List Management (unlimited locations)",
      "Review Management (unlimited)",
      "Post Management (unlimited)",
...
const addons = [
  ...
  },
  {
    ...
    description: "Expand your list management to 10 more business locations",
    category: "capacity",
    icon: "MapPin",
    price: "49.00",
    billingCycle: "monthly",
  ...
  },
  {
    ...
    description: "Expand your list management to 50 more business locations",
    category: "capacity",
    icon: "Building",
    price: "199.00",
    billingCycle: "monthly",
